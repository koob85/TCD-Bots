...
let Database = Modules.DatabaseHandler
...
Database.GetValue("Hype")
	.then(dataStoreHype => {
		currentHype = dataStoreHype
		saveHype = true
	})

Database.GetValue("HypeEnabled")
...
function saveLoop() {
	...
	setTimeout(function () {
		Database.SetValue("Hype", currentHype)
		saveLoop();
	}, 10000); // 60 // 1 Minute
}
